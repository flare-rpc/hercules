...
Status
ValidateEnsembleSchedulingConfig(const hercules::proto::ModelConfig& config)
{
    ...
    const std::string& message_prefix = "")
{
  ...
  if (io.data_type() == hercules::proto::DataType::TYPE_INVALID) {
    return Status(
        ...
        *tensor_name = control_input.name();
        ...
        if (c.int32_false_true_size() > 0) {
          ...
          if (tensor_datatype != nullptr) {
            *tensor_datatype = hercules::proto::DataType::TYPE_INT32;
          }
          ...
          if (tensor_datatype != nullptr) {
            *tensor_datatype = hercules::proto::DataType::TYPE_FP32;
          }
          ...
          if (tensor_datatype != nullptr) {
            *tensor_datatype = hercules::proto::DataType::TYPE_BOOL;
          }
    ...
    if (required) {
      return Status(
          ...
          "sequence batching control tensor must specify a " +
              hercules::proto::ModelSequenceBatching_Control_Kind_Name(control_kind) +
    ...
    const double min_compute_capability, hercules::proto::ModelConfig* config)
{
  ...
  if (!config->has_version_policy()) {
    hercules::proto::ModelVersionPolicy::Latest latest;
  ...
  if (!config->has_ensemble_scheduling()) {
    ...
    if (config->instance_group().size() == 0) {
      hercules::proto::ModelInstanceGroup* group = config->add_instance_group();
    ...
    for (auto& group : *config->mutable_instance_group()) {
      ...
      if (group.kind() == hercules::proto::ModelInstanceGroup::KIND_AUTO) {
        if (supported_gpus.empty()) {
          group.set_kind(hercules::proto::ModelInstanceGroup::KIND_CPU);
        } else {
        ...
        if (group.kind() == hercules::proto::ModelInstanceGroup::KIND_AUTO) {
          group.set_kind(hercules::proto::ModelInstanceGroup::KIND_GPU);
        }
      }
      ...
      // GPUs
      if ((group.kind() == hercules::proto::ModelInstanceGroup::KIND_GPU) &&
          (group.gpus().size() == 0)) {
    ...
    hercules::proto::ModelInstanceGroup* group, const std::string& backend)
{
  ...
  if (group->kind() == hercules::proto::ModelInstanceGroup::KIND_CPU &&
...
Status
ValidateModelIOConfig(const hercules::proto::ModelConfig& config)
{
  Status status;
...
Status
ValidateBatchIO(const hercules::proto::ModelConfig& config)
{
  ...
  for (const auto& batch_io : config.batch_input()) {
    switch (batch_io.kind()) {
      case hercules::proto::BatchInput::BATCH_ELEMENT_COUNT:
      case hercules::proto::BatchInput::BATCH_ACCUMULATED_ELEMENT_COUNT:
      case hercules::proto::BatchInput::BATCH_ACCUMULATED_ELEMENT_COUNT_WITH_ZERO:
      case hercules::proto::BatchInput::BATCH_MAX_ELEMENT_COUNT_AS_SHAPE:
      case hercules::proto::BatchInput::BATCH_ITEM_SHAPE:
      case hercules::proto::BatchInput::BATCH_ITEM_SHAPE_FLATTEN: {
        if (batch_io.source_input_size() != 1) {
          return Status(
              Status::Code::INVALID_ARG,
              "batch input kind '" +
                  hercules::proto::BatchInput::Kind_Name(batch_io.kind()) +
    ...
    if ((batch_io.data_type() != hercules::proto::DataType::TYPE_INT32) &&
        (batch_io.data_type() != hercules::proto::DataType::TYPE_FP32)) {
      return Status(
          Status::Code::INVALID_ARG,
  ...
  for (const auto& batch_io : config.batch_output()) {
    switch (batch_io.kind()) {
      case hercules::proto::BatchOutput::BATCH_SCATTER_WITH_INPUT_SHAPE: {
        if (batch_io.source_input_size() != 1) {
          return Status(
              Status::Code::INVALID_ARG,
              "batch output kind '" +
                  hercules::proto::BatchOutput::Kind_Name(batch_io.kind()) +
                  "' expects 1 source input, got " +
                  std::to_string(batch_io.source_input_size()));
        }
        break;
    ...
    const hercules::proto::ModelConfig& config, const double min_compute_capability)
{
    ...
    if (config.dynamic_batching().preserve_ordering()) {
      ...
      if ((default_policy.default_timeout_microseconds() != 0) &&
          (default_policy.timeout_action() ==
           hercules::proto::ModelQueuePolicy::DELAY)) {
        return Status(
            Status::Code::INVALID_ARG,
  ...
  if (config.has_sequence_batching()) {
    ...
    RETURN_IF_ERROR(GetBooleanSequenceControlProperties(
        batcher, config.name(),
        hercules::proto::ModelSequenceBatching::Control::CONTROL_SEQUENCE_START,
        false /* required */, &tensor_name, nullptr, nullptr, nullptr, nullptr,
        nullptr, nullptr, nullptr));
    RETURN_IF_ERROR(GetBooleanSequenceControlProperties(
        batcher, config.name(),
        hercules::proto::ModelSequenceBatching::Control::CONTROL_SEQUENCE_END,
        false /* required */, &tensor_name, nullptr, nullptr, nullptr, nullptr,
        nullptr, nullptr, nullptr));
    RETURN_IF_ERROR(GetBooleanSequenceControlProperties(
        batcher, config.name(),
        hercules::proto::ModelSequenceBatching::Control::CONTROL_SEQUENCE_READY,
        false /* required */, &tensor_name, nullptr, nullptr, nullptr, nullptr,
        nullptr, nullptr, nullptr));
    ...
    RETURN_IF_ERROR(GetTypedSequenceControlProperties(
        batcher, config.name(),
        hercules::proto::ModelSequenceBatching::Control::CONTROL_SEQUENCE_CORRID,
        false /* required */, &tensor_name, &tensor_datatype));
    if (!tensor_name.empty()) {
      if ((tensor_datatype != hercules::proto::DataType::TYPE_UINT64) &&
          (tensor_datatype != hercules::proto::DataType::TYPE_INT64) &&
          (tensor_datatype != hercules::proto::DataType::TYPE_UINT32) &&
          (tensor_datatype != hercules::proto::DataType::TYPE_INT32) &&
          (tensor_datatype != hercules::proto::DataType::TYPE_STRING)) {
        return Status(
            Status::Code::INVALID_ARG,
    ...
    const std::string& platform)
{
  ...
  if (((io.format() == hercules::proto::ModelInput::FORMAT_NHWC) ||
       (io.format() == hercules::proto::ModelInput::FORMAT_NCHW)) &&
      (io.dims_size() != 3)) {
    return Status(
...
DataTypeToTriton(const hercules::proto::DataType dtype)
{
  switch (dtype) {
    ...
    case hercules::proto::DataType::TYPE_STRING:
...
TritonToDataType(const TRITONSERVER_DataType dtype)
{
  switch (dtype) {
    ...
    case TRITONSERVER_TYPE_BYTES:
      return hercules::proto::DataType::TYPE_STRING;
