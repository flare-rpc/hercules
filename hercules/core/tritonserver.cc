...
namespace {
    ...
    std::string
    RateLimitModeToString(const hercules::core::RateLimitMode rate_limit_mode) {
        std::string rl_mode_str("<unknown>");
        switch (rate_limit_mode) {
            case hercules::core::RateLimitMode::RL_EXEC_COUNT: {
                rl_mode_str = "EXEC_COUNT";
                break;
            }
            case hercules::core::RateLimitMode::RL_OFF: {
                rl_mode_str = "OFF";
                break;
            }
        }
...
//
    ...
    public:
        ...
        static TRITONSERVER_Error *Create(const hercules::core::Status &status);
    ...
    TRITONSERVER_Error *
    TritonServerError::Create(const hercules::core::Status &status) {
        ...
        return Create(
                hercules::core::StatusCodeToTritonCode(status.StatusCode()), status.Message());
    }

#define RETURN_IF_STATUS_ERROR(S)                 \
  do {                                            \
    const hercules::core::Status& status__ = (S);             \
    if (!status__.IsOk()) {                       \
...
//
    ...
    TritonServerMetrics::Serialize(const char **base, size_t *byte_size) {
        ...
        serialized_ = hercules::core::Metrics::SerializedMetrics();
    ...
    public:
        ...
        hercules::core::ModelControlMode ModelControlMode() const { return model_control_mode_; }

        void SetModelControlMode(hercules::core::ModelControlMode m) { model_control_mode_ = m; }
        ...
        hercules::core::RateLimitMode RateLimiterMode() const { return rate_limit_mode_; }

        void SetRateLimiterMode(hercules::core::RateLimitMode m) { rate_limit_mode_ = m; }
        ...
        const hercules::core::RateLimiter::ResourceMap &RateLimiterResources() const {
        ...
        // internally.
        const hercules::common::BackendCmdlineConfigMap &BackendCmdlineConfigMap() const {
        ...
        const hercules::common::HostPolicyCmdlineConfigMap &HostPolicyCmdlineConfigMap()
        const {
    ...
    private:
        ...
        hercules::core::ModelControlMode model_control_mode_;
        std::set<std::string> models_;
        bool exit_on_error_;
        bool strict_model_config_;
        bool strict_readiness_;
        hercules::core::RateLimitMode rate_limit_mode_;
        hercules::core::RateLimiter::ResourceMap rate_limit_resource_map_;
        bool metrics_;
        bool gpu_metrics_;
    ...
    TritonServerOptions::TritonServerOptions()
            : server_id_("triton"),
              model_control_mode_(hercules::core::ModelControlMode::MODE_POLL),
              exit_on_error_(true), strict_model_config_(true), strict_readiness_(true),
              rate_limit_mode_(hercules::core::RateLimitMode::RL_OFF), metrics_(true),
...
#ifndef HERCULES_ENABLE_METRICS
        metrics_ = false;
        gpu_metrics_ = false;
#endif  // HERCULES_ENABLE_METRICS
    ...
    TritonServerOptions::AddBackendConfig(
            const std::string &backend_name, const std::string &setting,
            const std::string &value) {
        hercules::common::BackendCmdlineConfig &cc =
    ...
    TritonServerOptions::SetHostPolicy(
        ...
        hercules::common::HostPolicyCmdlineConfig &hp = host_policy_map_[policy_name];
        hp[setting] = value;
...
TRITONSERVER_StringToDataType(const char *dtype) {
    ...
    return hercules::core::DataTypeToTriton(
            hercules::common::ProtocolStringToDataType(dtype, len));
}
...
TRITONSERVER_ParameterNew(
    ...
    std::unique_ptr<hercules::core::inference_parameter> lparam;
    switch (type) {
        case TRITONSERVER_PARAMETER_STRING:
            lparam.reset(new hercules::core::inference_parameter(
...
TRITONSERVER_ParameterBytesNew(
    ...
    std::unique_ptr<hercules::core::inference_parameter> lparam(
            new hercules::core::inference_parameter(name, byte_ptr, size));
    return reinterpret_cast<TRITONSERVER_Parameter *>(lparam.release());
}

TRITONAPI_DECLSPEC void
TRITONSERVER_ParameterDelete(TRITONSERVER_Parameter *parameter) {
    delete reinterpret_cast<hercules::core::inference_parameter *>(parameter);
}
...
TRITONSERVER_ErrorCodeString(TRITONSERVER_Error *error) {
    TritonServerError *lerror = reinterpret_cast<TritonServerError *>(error);
    return hercules::core::Status::CodeString(hercules::core::TritonCodeToStatusCode(lerror->Code()));
}
...
TRITONSERVER_ResponseAllocatorNew(
    ...
    *allocator = reinterpret_cast<TRITONSERVER_ResponseAllocator *>(
            new hercules::core::ResponseAllocator(alloc_fn, release_fn, start_fn));
    return nullptr;  // Success
}
...
TRITONSERVER_ResponseAllocatorSetQueryFunction(
    ...
    reinterpret_cast<hercules::core::ResponseAllocator *>(allocator)->SetQueryFunction(
            query_fn);
    return nullptr;  // success
}
...
TRITONSERVER_ResponseAllocatorSetBufferAttributesFunction(
    ...
    reinterpret_cast<hercules::core::ResponseAllocator *>(allocator)
...
TRITONSERVER_ResponseAllocatorDelete(TRITONSERVER_ResponseAllocator *allocator) {
    hercules::core::ResponseAllocator *lalloc =
            reinterpret_cast<hercules::core::ResponseAllocator *>(allocator);
    delete lalloc;
    return nullptr;  // Success
}
...
TRITONSERVER_MessageNewFromSerializedJson(
    ...
    *message = reinterpret_cast<TRITONSERVER_Message *>(
            new hercules::core::TritonServerMessage({base, byte_size}));
    return nullptr;
}

TRITONAPI_DECLSPEC TRITONSERVER_Error *
TRITONSERVER_MessageDelete(TRITONSERVER_Message *message) {
    hercules::core::TritonServerMessage *lmessage =
            reinterpret_cast<hercules::core::TritonServerMessage *>(message);
    delete lmessage;
    return nullptr;  // Success
}
...
TRITONSERVER_InferenceTraceNew(
    ...
    hercules::core::InferenceTrace* ltrace = new hercules::core::InferenceTrace(
...
#ifdef HERCULES_ENABLE_TRACING
    hercules::core::InferenceTrace* ltrace = reinterpret_cast<hercules::core::InferenceTrace*>(trace);
    delete ltrace;
    return nullptr;  // Success
#else
    return TRITONSERVER_ErrorNew(
...
TRITONSERVER_ServerOptionsSetModelControlMode(
    ...
    // convert mode from TRITONSERVER_ to hercules::core
    switch (mode) {
        case TRITONSERVER_MODEL_CONTROL_NONE: {
            loptions->SetModelControlMode(hercules::core::ModelControlMode::MODE_NONE);
            break;
        }
        case TRITONSERVER_MODEL_CONTROL_POLL: {
            loptions->SetModelControlMode(hercules::core::ModelControlMode::MODE_POLL);
            break;
        }
        case TRITONSERVER_MODEL_CONTROL_EXPLICIT: {
            loptions->SetModelControlMode(hercules::core::ModelControlMode::MODE_EXPLICIT);
            break;
        }
        default: {
            return TRITONSERVER_ErrorNew(
...
TRITONSERVER_ServerOptionsSetRateLimiterMode(
    ...
    switch (mode) {
        case TRITONSERVER_RATE_LIMIT_EXEC_COUNT: {
            loptions->SetRateLimiterMode(hercules::core::RateLimitMode::RL_EXEC_COUNT);
            break;
        }
        case TRITONSERVER_RATE_LIMIT_OFF: {
            loptions->SetRateLimiterMode(hercules::core::RateLimitMode::RL_OFF);
            break;
        }
        default: {
            return TRITONSERVER_ErrorNew(
...
TRITONSERVER_ServerOptionsSetLogFormat(
    ...
    switch (format) {
      case TRITONSERVER_LOG_DEFAULT:
        LOG_SET_FORMAT(hercules::common::Logger::Format::kDEFAULT);
        break;
      case TRITONSERVER_LOG_ISO8601:
        LOG_SET_FORMAT(hercules::common::Logger::Format::kISO8601);
        break;
    }
#else
    return TRITONSERVER_ErrorNew(
...
TRITONSERVER_InferenceRequestNew(
    ...
    hercules::core::inference_server *lserver = reinterpret_cast<hercules::core::inference_server *>(server);

    std::shared_ptr<hercules::core::Model> model;
    ...
    *inference_request = reinterpret_cast<TRITONSERVER_InferenceRequest *>(
            new hercules::core::inference_request(model, model_version));
...
TRITONSERVER_InferenceRequestDelete(
        TRITONSERVER_InferenceRequest *inference_request) {
    hercules::core::inference_request *lrequest =
            reinterpret_cast<hercules::core::inference_request *>(inference_request);
    delete lrequest;
    return nullptr;  // Success
}
...
TRITONSERVER_InferenceRequestCorrelationId(
    ...
    hercules::core::inference_request *lrequest =
            reinterpret_cast<hercules::core::inference_request *>(inference_request);
    const hercules::core::inference_request::SequenceId &corr_id = lrequest->CorrelationId();
    if (corr_id.Type() != hercules::core::inference_request::SequenceId::DataType::UINT64) {
        return TRITONSERVER_ErrorNew(
                TRITONSERVER_ERROR_INVALID_ARG,
...
TRITONSERVER_InferenceRequestCorrelationIdString(
    ...
    hercules::core::inference_request *lrequest =
            reinterpret_cast<hercules::core::inference_request *>(inference_request);
    const hercules::core::inference_request::SequenceId &corr_id = lrequest->CorrelationId();
    if (corr_id.Type() != hercules::core::inference_request::SequenceId::DataType::STRING) {
        return TRITONSERVER_ErrorNew(
                TRITONSERVER_ERROR_INVALID_ARG,
...
TRITONSERVER_InferenceRequestSetCorrelationId(
    ...
    hercules::core::inference_request *lrequest =
            reinterpret_cast<hercules::core::inference_request *>(inference_request);
    lrequest->SetCorrelationId(hercules::core::inference_request::SequenceId(correlation_id));
    return nullptr;  // Success
}
...
TRITONSERVER_InferenceRequestAddInput(
    ...
    RETURN_IF_STATUS_ERROR(lrequest->AddOriginalInput(
            name, hercules::core::TritonToDataType(datatype), shape, dim_count));
    return nullptr;  // Success
}
...
TRITONSERVER_InferenceRequestAppendInputData(
    ...
    hercules::core::inference_request::Input *input;
...
TRITONSERVER_InferenceRequestAppendInputDataWithBufferAttributes(
    ...
    hercules::core::inference_request *lrequest =
            reinterpret_cast<hercules::core::inference_request *>(inference_request);
    hercules::core::buffer_attributes *lbuffer_attributes =
            reinterpret_cast<hercules::core::buffer_attributes *>(attr);
...
TRITONSERVER_InferenceRequestSetResponseCallback(
    ...
    hercules::core::inference_request *lrequest =
            reinterpret_cast<hercules::core::inference_request *>(inference_request);
    hercules::core::ResponseAllocator *lallocator =
            reinterpret_cast<hercules::core::ResponseAllocator *>(response_allocator);
...
TRITONSERVER_InferenceResponseDelete(
    ...
    hercules::core::InferenceResponse *lresponse =
            reinterpret_cast<hercules::core::InferenceResponse *>(inference_response);
    delete lresponse;
    return nullptr;  // Success
}
...
TRITONSERVER_InferenceResponseParameter(
    ...
    const hercules::core::inference_parameter &param = parameters[index];
...
TRITONSERVER_InferenceResponseOutput(
    ...
    const hercules::core::InferenceResponse::Output &output = outputs[index];

    *name = output.Name().c_str();
    *datatype = hercules::core::DataTypeToTriton(output.DType());
...
TRITONSERVER_BufferAttributesNew(
    ...
    hercules::core::buffer_attributes *lbuffer_attributes = new hercules::core::buffer_attributes();
    *attr =
...
TRITONSERVER_ServerNew(
    ...
    hercules::core::inference_server *lserver = new hercules::core::inference_server();
    TritonServerOptions *loptions =
            reinterpret_cast<TritonServerOptions *>(options);
    ...
    if (loptions->Metrics()) {
      hercules::core::Metrics::EnableMetrics();
      hercules::core::Metrics::SetMetricsInterval(loptions->MetricsInterval());
    }
#endif  // HERCULES_ENABLE_METRICS
    ...
    // Initialize server
    hercules::core::Status status = lserver->Init();
    ...
    if (loptions->Metrics() && lserver->ResponseCacheEnabled()) {
      ...
      // server->Init()
      hercules::core::Metrics::EnableCacheMetrics(lserver->GetResponseCache());
    }
#ifdef TRITON_ENABLE_METRICS_GPU
    if (loptions->Metrics() && loptions->GpuMetrics()) {
      hercules::core::Metrics::EnableGPUMetrics();
    }
#endif  // TRITON_ENABLE_METRICS_GPU
    ...
    if (loptions->Metrics() &&
      ...
      hercules::core::Metrics::StartPollingThreadSingleton(lserver->GetResponseCache());
    }
#endif  // HERCULES_ENABLE_METRICS
    ...
    hercules::common::TablePrinter options_table(options_headers);
    ...
    switch (control_mode) {
        case hercules::core::ModelControlMode::MODE_NONE: {
            model_control_mode = "MODE_NONE";
            break;
        }
        case hercules::core::ModelControlMode::MODE_POLL: {
            model_control_mode = "MODE_POLL";
            break;
        }
        case hercules::core::ModelControlMode::MODE_EXPLICIT: {
...
TRITONSERVER_ServerRegisterModelRepository(
    ...
    for (size_t i = 0; i < mapping_count; ++i) {
        auto mapping =
                reinterpret_cast<const hercules::core::inference_parameter *>(name_mapping[i]);
...
TRITONSERVER_ServerMetadata(
    ...
    *server_metadata = reinterpret_cast<TRITONSERVER_Message *>(
            new hercules::core::TritonServerMessage(metadata));
    return nullptr;  // Success
}
...
TRITONSERVER_ServerModelConfig(
    ...
    RETURN_IF_STATUS_ERROR(hercules::core::ModelConfigToJson(
            model->Config(), config_version, &model_config_json));

    *model_config = reinterpret_cast<TRITONSERVER_Message *>(
            new hercules::core::TritonServerMessage(std::move(model_config_json)));
...
TRITONSERVER_ServerModelIndex(
    ...
    std::vector<hercules::core::ModelRepositoryManager::ModelIndex> index;
    ...
    for (const auto &in : index) {
        ...
        if (!in.name_only_) {
            ...
            RETURN_IF_STATUS_ERROR(model_index.AddStringRef(
                    "state", hercules::core::ModelReadyStateString(in.state_).c_str()));
            if (!in.reason_.empty()) {
                RETURN_IF_STATUS_ERROR(
    ...
    *repository_index = reinterpret_cast<TRITONSERVER_Message *>(
            new hercules::core::TritonServerMessage(repository_index_json));
...
TRITONSERVER_ServerLoadModelWithParameters(
    ...
    std::unordered_map<std::string, std::vector<const hercules::core::inference_parameter *>>
            models;
    std::vector<const hercules::core::inference_parameter *> mp;
    for (size_t i = 0; i < parameter_count; ++i) {
        mp.emplace_back(
                reinterpret_cast<const hercules::core::inference_parameter *>(parameters[i]));
    }
...
TRITONSERVER_ServerUnloadModelAndDependents(
        TRITONSERVER_Server *server, const char *model_name) {
    {
        hercules::core::inference_server *lserver =
                reinterpret_cast<hercules::core::inference_server *>(server);
...
TRITONSERVER_ServerInferAsync(
    ...
    if (trace != nullptr) {
        ...
        lrequest->SetTrace(std::make_shared<hercules::core::InferenceTraceProxy>(ltrace));
#else
        return TRITONSERVER_ErrorNew(
                TRITONSERVER_ERROR_UNSUPPORTED, "inference tracing not supported");
#endif  // HERCULES_ENABLE_TRACING
    ...
    std::unique_ptr<hercules::core::inference_request> ureq(lrequest);

    // Run inference...
    hercules::core::Status status = lserver->InferAsync(ureq);
...
TRITONSERVER_MetricFamilyNew(
    ...
    try {
      *family = reinterpret_cast<TRITONSERVER_MetricFamily*>(
          new hercules::core::MetricFamily(kind, name, description));
    }
...
#ifdef HERCULES_ENABLE_METRICS
    delete reinterpret_cast<hercules::core::MetricFamily*>(family);
    return nullptr;  // Success
#else
    return TRITONSERVER_ErrorNew(
            TRITONSERVER_ERROR_UNSUPPORTED, "metrics not supported");
...
#ifdef HERCULES_ENABLE_METRICS
    std::vector<const hercules::core::inference_parameter*> labels_vec;
    for (size_t i = 0; i < label_count; i++) {
      labels_vec.emplace_back(
          reinterpret_cast<const hercules::core::inference_parameter*>(labels[i]));
    }

    try {
      *metric = reinterpret_cast<TRITONSERVER_Metric*>(
          new hercules::core::Metric(family, labels_vec));
    }
    catch (std::invalid_argument const& ex) {
      // Catch invalid kinds passed to constructor
      return TRITONSERVER_ErrorNew(TRITONSERVER_ERROR_INVALID_ARG, ex.what());
...
#ifdef HERCULES_ENABLE_METRICS
    delete reinterpret_cast<hercules::core::Metric*>(metric);
    return nullptr;  // Success
#else
    return TRITONSERVER_ErrorNew(
            TRITONSERVER_ERROR_UNSUPPORTED, "metrics not supported");
...
#ifdef HERCULES_ENABLE_METRICS
    return reinterpret_cast<hercules::core::Metric*>(metric)->Value(value);
#else
    return TRITONSERVER_ErrorNew(
            TRITONSERVER_ERROR_UNSUPPORTED, "metrics not supported");
#endif  // HERCULES_ENABLE_METRICS
...
#ifdef HERCULES_ENABLE_METRICS
    return reinterpret_cast<hercules::core::Metric*>(metric)->Increment(value);
#else
    return TRITONSERVER_ErrorNew(
            TRITONSERVER_ERROR_UNSUPPORTED, "metrics not supported");
#endif  // HERCULES_ENABLE_METRICS
...
#ifdef HERCULES_ENABLE_METRICS
    return reinterpret_cast<hercules::core::Metric*>(metric)->Set(value);
#else
    return TRITONSERVER_ErrorNew(
            TRITONSERVER_ERROR_UNSUPPORTED, "metrics not supported");
#endif  // HERCULES_ENABLE_METRICS
...
#ifdef HERCULES_ENABLE_METRICS
    *kind = reinterpret_cast<hercules::core::Metric*>(metric)->Kind();
    return nullptr;  // Success
#else
    return TRITONSERVER_ErrorNew(
            TRITONSERVER_ERROR_UNSUPPORTED, "metrics not supported");
