...
namespace hercules::core {
    ...
    //
    // memory_base used to access data in inference requests
    //
    class memory_base {
    public:
        ...
        virtual const char *buffer_at(
                size_t idx, buffer_attributes **attr) = 0;
    ...
    public:
        ...
        const char *buffer_at(
                size_t idx, buffer_attributes **attr) override;
        ...
        size_t add_buffer(const char *buffer, buffer_attributes *attr);
    ...
    private:
        struct Block {
            ...
            Block(const char *buffer, buffer_attributes *attr)
