  ...
  if (lhs.type_ != rhs.type_) {
    return Status(
        ...
        message + "inconsistent data type: " +
            hercules::proto::DataType_Name(lhs.type_) + " is inferred from model " +
            lhs.model_name_ + " while " + hercules::proto::DataType_Name(rhs.type_) +
...
ValidateTensorMapping(
    const std::string& ensemble, const hercules::proto::ModelEnsembling::Step& step,
